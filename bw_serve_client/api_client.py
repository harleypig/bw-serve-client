...
import bw_serve_client.models
from bw_serve_client import rest
from bw_serve_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self,
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.4a0/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bw_serve_client.models, klass)
