...
class LockunlockSuccessData(BaseModel):
    """
    LockunlockSuccessData
    """
    message: Optional[StrictStr] = None
    no_color: Optional[StrictBool] = Field(None, alias="noColor")
    object: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties = ["message", "noColor", "object", "title"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LockunlockSuccessData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LockunlockSuccessData:
        """Create an instance of LockunlockSuccessData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LockunlockSuccessData.parse_obj(obj)

        _obj = LockunlockSuccessData.parse_obj({
            "message": obj.get("message"),
            "no_color": obj.get("noColor"),
