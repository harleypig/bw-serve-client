...
class SendText(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendText:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendText:
        """Create an instance of SendText from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SendText.parse_obj(obj)

        _obj = SendText.parse_obj({
