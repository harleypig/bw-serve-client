...
from bw_serve_client.models.item_login import ItemLogin  # noqa: E501

class TestItemLogin(unittest.TestCase):
    """ItemLogin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemLogin:
        """Test ItemLogin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemLogin`
        """
        model = ItemLogin()  # noqa: E501
        if include_optional:
            return ItemLogin(
                password = '',
                totp = '',
