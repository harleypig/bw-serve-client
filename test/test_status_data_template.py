...
class TestStatusDataTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatusDataTemplate:
        """Test StatusDataTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusDataTemplate`
        """
        model = StatusDataTemplate()  # noqa: E501
        if include_optional:
    ...
    def testStatusDataTemplate(self):
        """Test StatusDataTemplate"""
