...
class TestUnlockPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UnlockPostRequest:
        """Test UnlockPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnlockPostRequest`
        """
        model = UnlockPostRequest()  # noqa: E501
        if include_optional:
            return UnlockPostRequest(
                password = ''
            )
        else:
            return UnlockPostRequest(
    ...
    def testUnlockPostRequest(self):
        """Test UnlockPostRequest"""
